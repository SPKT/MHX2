<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewPostUC.ascx.cs"
    Inherits="SPKTWeb.Groups.UserControl.ViewPostUC" %>
...
<div class="divContainerUC" style="border-width: 0px; border-color: White; padding-left:2%;">
        ...
        <div class="divContainerRow" style="border-width: 0px; border-color: White">
            <div style="">
                <div align="left" class="Main_Subject">
                    <asp:Label ID="lblSubject" runat="server" Width="100%" Height="100%"></asp:Label>
                </div>
                ...
                <div style="">
                    ...
                    <div style="float: none">
                        <div style="font-size: small; width: 80%; color: Gray">
                            ...
                            Ngày tạo:
                            <asp:Label Font-Size="Small" ID="lblCreateDate" runat="server"></asp:Label>
                        ...
                        <div style="margin-top: 10px;">
                            <div style="">
                                ...
                                <div style="float: none">
                                    <div style="font-size: small; width: 70%; color: Gray">
                                        <asp:HyperLink ID="linkUsername" NavigateUrl='<%# "/" + ((BoardPost)Container.DataItem).Username %>'
                                            runat="server" Text='<%#((BoardPost)Container.DataItem).Username %>'></asp:HyperLink>
                            ...
                            <div>
                                ...
                                <div style="float: right; margin-bottom: 20px;">
                                    <asp:HyperLink runat="server" ID="hlkShowReply" NavigateUrl='<%#  "~/Groups/ViewGroupForumPost.aspx?PostID="+((BoardPost)Container.DataItem).PostID+"&GroupID="+((BoardPost)Container.DataItem).groupID%>'
                                        Text="Xem Bình Luận"></asp:HyperLink>
                                    <asp:HyperLink runat="server" ID="linkReply" NavigateUrl='<%#  "/Groups/PostGroupforum.aspx?" + "IsThread=" + 0 + "&ForumID=" + ((BoardPost)Container.DataItem).ForumID + "&GroupID=" + ((BoardPost)Container.DataItem).groupID+"&PostID="+ ((BoardPost)Container.DataItem).PostID%>'
                                        Text="Bình Luận"></asp:HyperLink>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
