...
<div align="center" style="border: 1px solid #999999; font-family: Constantia; font-weight: bold;
    color: #006600; background-repeat: repeat-x;
    width: 100%; height: 25; padding-bottom: 10px; background-image: url('../../Image/thead.gif');">
    <asp:LinkButton ID="lbt_Friend" runat="server" Font-Names="Times New Roman" Font-Underline="False"
        ForeColor="#CC0000">Danh Sách Bạn Bè</asp:LinkButton>
    <div style="background-color: #CC0000; height:2px; margin-top:8px;"></div>
