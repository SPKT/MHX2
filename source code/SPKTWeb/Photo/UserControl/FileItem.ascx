<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FileItem.ascx.cs" Inherits="SPKTWeb.Photo.UserControl.FileItem" %>
<%@ Register Src="~/UserControl/Comments.ascx" TagName="Comments" TagPrefix="uc1" %>
